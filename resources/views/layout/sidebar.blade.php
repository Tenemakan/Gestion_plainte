    ...
    <div class="p-3 d-flex flex-column h-100">
        ...
        <ul class="nav flex-column menu-items">
            <li class="nav-item mb-2">
                <a href="{{ route('users') }}" class="nav-link {{ request()->is('/') ? 'active bg-primary bg-opacity-25 text-white fw-bold' : 'text-white-50 hover-white' }}">
            ...
            <li class="nav-item mb-2">
                <a href="{{ route('plainte_en_cours') }}" class="nav-link {{ request()->is('plainte_en_cours') ? 'active bg-primary bg-opacity-25 text-white fw-bold' : 'text-white-50 hover-white' }}">
                    <div class="d-flex align-items-center">
                        <div class="icon-container me-3">
            ...
            <li class="nav-item mb-2">
                <a href="{{ route('plainte_terminee') }}" class="nav-link {{ request()->is('plainte_terminee') ? 'active bg-primary bg-opacity-25 text-white fw-bold' : 'text-white-50 hover-white' }}">
                    <div class="d-flex align-items-center">
                        <div class="icon-container me-3">
            ...
            <li class="nav-item mb-2">
                <a href="{{ route('plainte_refusee') }}" class="nav-link {{ request()->is('plainte_refusee') ? 'active bg-primary bg-opacity-25 text-white fw-bold' : 'text-white-50 hover-white' }}">
                    <div class="d-flex align-items-center">
                        <div class="icon-container me-3">
                ...
                <div class="user-profile p-2 rounded mb-3">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <small class="text-white-50"><i class="fas fa-edit me-1"></i>Gérer mon profil</small>
                            </div>
                        </div>
                    </div>
                </div>
