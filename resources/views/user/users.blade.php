        ...
        <div class="col-md-6 col-lg-3 mb-4">
            <div class="card h-100 border-0 shadow-sm rounded-3 hover-card">
                ...
                <div class="card-footer bg-white border-0 text-center pb-3">
                    <a href="#" class="btn action-btn w-75" data-bs-toggle="modal" data-bs-target="#plainteModal">Déposer <i class="fas fa-arrow-right ms-1"></i></a>
                </div>
            </div>
        </div>

        <!-- Plainte en cours Card -->
        <div class="col-md-6 col-lg-3 mb-4">
            <div class="card h-100 border-0 shadow-sm rounded-3 hover-card">
                <div class="card-body d-flex flex-column align-items-center justify-content-center p-4">
                ...
                <div class="card-footer bg-white border-0 text-center pb-3">
                    <a href="{{ route('plainte_en_cours') }}" class="btn action-btn w-75">Consulter <i class="fas fa-arrow-right ms-1"></i></a>
                </div>
            </div>
        </div>

        <!-- Plainte Terminee Card -->
        <div class="col-md-6 col-lg-3 mb-4">
            <div class="card h-100 border-0 shadow-sm rounded-3 hover-card">
                <div class="card-body d-flex flex-column align-items-center justify-content-center p-4">
                ...
                <div class="card-footer bg-white border-0 text-center pb-3">
                    <a href="{{ route('plainte_terminee') }}" class="btn action-btn w-75">Consulter <i class="fas fa-arrow-right ms-1"></i></a>
                </div>
            </div>
        </div>

        <!-- Plainte Refusee Card -->
        <div class="col-md-6 col-lg-3 mb-4">
            <div class="card h-100 border-0 shadow-sm rounded-3 hover-card">
                <div class="card-body d-flex flex-column align-items-center justify-content-center p-4">
                ...
                <div class="card-footer bg-white border-0 text-center pb-3">
                    <a href="{{ route('plainte_refusee') }}" class="btn action-btn w-75">Consulter <i class="fas fa-arrow-right ms-1"></i></a>
                </div>
            </div>
        </div>
    </div>
